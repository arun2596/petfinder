...
def adjust_learning_rate(optimizer, epoch, lr, learning_rate_drop_every, learning_rate_drop_factor=0.1):
    """Sets the learning rate to the initial LR decayed by 10 every 30 epochs"""
    lr = lr * (learning_rate_drop_factor ** (epoch // learning_rate_drop_every))
